...
function enableDebugging(addinId, enable = true, method = dev_settings_1.DebuggingMethod.Proxy) {
    return __awaiter(this, void 0, void 0, function* () {
        const key = getDeveloperSettingsRegistryKey(addinId);
...
function getDeveloperSettingsRegistryKey(addinId) {
    if (!addinId) {
        throw new Error("addinId is required.");
    }
    if (typeof addinId !== "string") {
        throw new Error("addinId should be a string.");
    }
